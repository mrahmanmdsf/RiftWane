 ...
 * This file demonstrates how to integrate Riftwane with a web frontend
 */

// For React/Vue/Angular applications
export class RiftwaneClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new RiftwaneClient(provider, contractAddress);
